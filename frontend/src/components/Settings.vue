          ...
          >
            <div class="account-grid">
              <div class="account-avatar">
                ...
                <el-button class="ghost-btn" size="small" @click="showComingSoon">更换头像</el-button>
              </div>
        ...
        <div v-else-if="activeKey === 'logout'" class="settings-section">
          ...
          <div class="logout-card">
            <div class="logout-card__main">
              <div class="logout-card__avatar">{{ avatarLetter }}</div>
...
// 模拟当前登录用户（数据写死，实际项目可由 store / 接口获取）
const mockUser = {
  username: 'admin',
  nickname: '管理员',
  email: 'admin@example.com',
  phone: '',
  lastLoginAt: '2026-05-09 21:42',
  currentDevice: 'Windows · Chrome 124',
}

// ---------- 个人资料 ----------
const profileFormRef = ref<FormInstance>()
const profileSaving = ref(false)
const profileForm = reactive({ ...mockUser })
...
const saveProfile = async () => {
  ...
  Object.assign(mockUser, profileForm)
...
const lastLoginAt = computed(() => mockUser.lastLoginAt)
const currentDevice = computed(() => mockUser.currentDevice)
